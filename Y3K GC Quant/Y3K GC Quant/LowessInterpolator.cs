...
{
    class LowessInterpolator
    {
        //All code taken from http://stackoverflow.com/questions/5651709/c-sharp-loess-lowess-regression
        ...
        public LowessInterpolator()
        {
            this.bandwidth = DEFAULT_BANDWIDTH;
            this.robustnessIters = DEFAULT_ROBUSTNESS_ITERS;
        }

        public LowessInterpolator(double bandwidth, int robustnessIters)
        {
